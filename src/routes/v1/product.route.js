...
router.post(auth('/create'), validate(productValidation.createProduct), productController.createProduct);
router.put(auth('/update'), validate(productValidation.updateProduct), productController.updateProduct);
router.delete(auth('/delete'), validate(productValidation.deleteProduct), productController.deleteProduct);
